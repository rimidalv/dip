...
import ru.avangard.tensorflow.env.SplitTimer;
...
//    };
    ...
    private static final double[] ANCHORS = {
            0.33992409257521888, 0.33719247281963817,
            1.0100595660834096,  0.71792034353366198,
            1.53047452891794924, 1.08287914762108248,
            1.78794817996499258, 1.42441122647150511,
            2.03988863446116426, 1.65701866299739031
    };
//    private static final double[] ANCHORS = {
//            0.63992409257521888, 0.33719247281963817,
//            1.4100595660834096,  0.71792034353366198,
//            2.03047452891794924, 1.08287914762108248,
//            2.68794817996499258, 1.42441122647150511,
//            3.03988863446116426, 1.65701866299739031
//    };
...
//    // Copy the input data into TensorFlow.
//    Trace.beginSection("feed");
//    inferenceInterface.feed("batch_normalization_1/keras_learning_phase", new boolean[]{false});
//    Trace.endSection();
